...
def get_anytime_td_prop_by_id(id):
    """Get an anytime TD prop by its ID"""
    return AnytimeTdProp.query.get(id)
...
def get_anytime_td_answers_for_prop(prop_id):
    """Get all anytime TD answers for a specific prop"""
    return AnytimeTdAnswer.query.filter_by(prop_id=prop_id).all()
...
def get_all_anytime_td_props_for_game(game_id):
    """Get all anytime TD props for a specific game"""
    return AnytimeTdProp.query.filter_by(game_id=game_id).all()
